...
import { kind, Platform, platforms } from '@buf/pugsh_pug.bufbuild_es/common/events/v1/options_pb.js'
...
const PACKAGE_PATH = '@buf/pugsh_pug.bufbuild_es/common/events/v1'
...
// Source: @buf/pugsh_pug.bufbuild_es@${bufVersion}
